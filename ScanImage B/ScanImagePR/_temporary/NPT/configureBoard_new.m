function [result] = configureBoard_new(boardHandle)
...
%         SLOW_EXTERNAL_CLOCK,		...	% U32 -- clock source id
...
triggerTimeout_clocks = uint32(0); % uint32(floor(triggerTimeout_sec / 10.e-6 + 0.5));
retCode = ...
...
%% essential point: use AUX_IN_TRIGGER_ENABLE in later use with frame trigger!! or AUX_OUT_TRIGGER ... ?
retCode = ...
