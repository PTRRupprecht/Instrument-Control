...
//     plhs[1] = mxCreateNumericArray(nb_pxls,nb_lines,mxDOUBLE_CLASS, mxREAL);
    y1 = (uint16_T *)mxGetData(mxCreateNumericMatrix(nb_pxls, nb_lines, mxUINT16_CLASS,mxREAL));
    y2 = (uint16_T *)mxGetData(mxCreateNumericMatrix(nb_pxls, nb_lines, mxUINT16_CLASS,mxREAL));
    plhs[0] = y1;
    plhs[1] = y2;
